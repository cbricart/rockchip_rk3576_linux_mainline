...
IMG_FILE="deploy/rk3576-photonicat2-mainline-ubuntu2604-full-${DATE_TS}.img"
...
BOOTFS_IMG_FILE="deploy/rk3576-photonicat2-mainline-ubuntu2604-full-bootfs.img"
ROOTFS_IMG_FILE="deploy/rk3576-photonicat2-mainline-ubuntu2604-full-rootfs.img"
